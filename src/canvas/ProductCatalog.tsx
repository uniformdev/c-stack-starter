...
type Props = ComponentProps<{
  ...
  activeCategory: Type.Category | Type.Category[];
  prefetchedSearchResult: Type.Product[];
}>;

const ProductCatalog: FC<Props> = ({
  title = '',
  categories,
  ...
  // Commercetools singe product parameter returns item wrapped in array (integration date structure question)
  const activeCategory = Array.isArray(activeCategories) ? activeCategories[0] : activeCategories;
